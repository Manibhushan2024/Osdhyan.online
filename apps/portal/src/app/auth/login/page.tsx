        ...
        <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="w-full max-w-md space-y-12 relative z-10">
                ...
                <div className="bg-white border border-slate-200 p-10 rounded-[3rem] shadow-xl shadow-indigo-500/5 relative">
                    <div className="absolute -top-px -right-px w-20 h-20 bg-gradient-to-br from-indigo-500/10 to-transparent rounded-tr-[3rem]" />

                    {error && (
                        <div className="mb-6 rounded-2xl bg-red-50 border border-red-100 p-4 animate-in fade-in slide-in-from-top-2">
                    ...
                    <form className="space-y-8" onSubmit={handleLogin}>
                        <div className="space-y-6">
                            <div>
                                <label htmlFor="login" className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4 mb-2">
                                    Identity Descriptor
                                </label>
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        id="login"
                                        required
                                        className="block w-full pl-12 pr-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all font-bold text-sm"
                            ...
                            <div>
                                <div className="flex items-center justify-between ml-4 mb-2">
                                    ...
                                    <Link href="/auth/forgot-password" className="text-[8px] font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-500">
                                        Key Recovery?
                                    </Link>
                                </div>
                                <div className="relative group">
                    ...
                    <div className="mt-10">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center">
                                <span className="px-4 bg-white text-[8px] font-black text-slate-400 uppercase tracking-[0.4em]">Alternative Auth</span>
                            </div>
                        </div>
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        setError('Google login unavailable. Please try again.');
                                        setGoogleLoading(false);
                                    }
                                }}
                                className="w-full py-4 border border-slate-200 rounded-2xl bg-white text-[10px] font-black text-slate-600 uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-50"
                            >
                                {googleLoading
                ...
                <p className="text-center">
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest mr-2">New Candidate?</span>
                    <Link href="/auth/signup" className="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-500 transition-colors">
                        Register Protocol
                    </Link>
                </p>
            </div>
