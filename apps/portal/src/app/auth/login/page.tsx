            ...
            <div className="w-full max-w-md space-y-12 relative z-10">
                ...
                <div className="bg-white border border-slate-200 p-10 rounded-[3rem] shadow-xl shadow-indigo-500/5 relative">
                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-8">
                            <button
                                className="w-full py-4 border border-slate-200 rounded-2xl bg-white text-[10px] font-black text-slate-600 uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                            >
